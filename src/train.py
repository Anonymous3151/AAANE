...
print 'Number of training examples: ', len(train_x), train_x.shape, overall_maxlen
...
for ii in xrange(args.epochs):
    ...
    for b in tqdm(xrange(batches_per_epoch)):
        ...
        #print("batchhhhh", len(sen_input), sen_input.shape, type(sen_input))
        #print("batchhhhh", len(neg_input), neg_input.shape, type(neg_input))
